/**
 * FlashStack -- Deploy hk-stx-real-receiver-v1 to mainnet
 *
 * Deploys from Hillary's own mainnet wallet (NOT the protocol deployer).
 * No admin-only whitelist call -- that has to happen from Matt's admin wallet
 * separately, via `add-approved-receiver` on flashstack-stx-core, before
 * the receiver can call flash-loan.
 *
 * Usage:
 *   MAINNET_MNEMONIC="word1 ... word24" node scripts/deploy-hk-real-receiver.mjs
 * Or, if mbegu2 file in repo root holds the 24-word mnemonic on a single line:
 *   node scripts/deploy-hk-real-receiver.mjs
 *
 * Optional env:
...
const NAME     = "hk-stx-real-receiver-v1";
const PATH     = "contracts/hk-stx-real-receiver-v1.clar";
...
async function main() {
  ...
  console.log("=======================================================");
  console.log("    FlashStack -- Deploy hk-stx-real-receiver-v1       ");
  console.log("=======================================================");
  ...
  await waitForConfirm(txid, "deploy hk-stx-real-receiver-v1");
