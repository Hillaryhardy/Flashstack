...
(define-constant POOL 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2)
...
(define-read-only (get-share-price)
  (let (
    (pool-balance (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-pool-balance))
    (total-shares (get total-shares (unwrap-panic (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-stats))))
  )
...
(define-read-only (get-total-shares)
  (get total-shares (unwrap-panic (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-stats)))
)

;; Returns total pool balance in microstacks
(define-read-only (get-pool-balance)
  (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-pool-balance)
)
...
(define-read-only (get-lp-value (lp principal))
  (let (
    (shares       (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-shares lp))
    (pool-balance (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-pool-balance))
    (total-shares (get total-shares (unwrap-panic (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-stats))))
  )
    (if (is-eq shares u0)
...
(define-read-only (get-lp-shares (lp principal))
  (ok (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-shares lp))
)
...
(define-read-only (get-collateral-snapshot)
  (let (
    (stats        (unwrap-panic (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-stats)))
    (pool-balance (contract-call? 'SPR9PQANV6XHSDNRAX2GNKCA5Z1KH61961KE0BYG.flashstack-stx-pool-v2 get-pool-balance))
