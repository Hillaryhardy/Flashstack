;; TEST-ONLY receiver: repays principal + fee, exercising the flash-loan happy path.
...
(define-public (execute-stx-flash (amount uint) (core principal))
  (let (
    (fee-bp  (unwrap! (contract-call? .flashstack-stx-core get-fee-basis-points) (err u901)))
